        ...
        <div className="hero_first_bg lg:flex-grow flex md:py-48 py-24 lg:py-0 h-full items-center">
          <div className="max-w-[1188px] mx-auto px-6 h-full">
            <div className="flex justify-center items-center flex-col">
              ...
              <p className="pt-4 text-center max-w-[777px] text-[#4A4A4A] text-base font-normal leading-normal font-Inter">
              ...
              <button className="text-white mt-8 w-[164px] h-[48px] hover:bg-white border-transparent hover:border-blue border-2 transition-all duration-300 hover:text-blue font-Inter font-semibold leading-normal text-base bg-blue flex justify-center items-center rounded-xl">
                Button
              </button>
            </div>
          </div>
