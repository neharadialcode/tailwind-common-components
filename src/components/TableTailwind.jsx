            ...
            <div className='container mx-auto px-4 py-10'>
                <div className=' overflow-x-auto lg:overflow-x-hidden min-w-full lg:min-w-0  rounded-xl '>
                    <table className="w-[736px] mg:w-full lg:w-full taiwindtable bg-[#212148] ">
                        <thead className='font-inter text-[#68688E] text-[12px] lg:text-[14px]'>
                            <tr>
                        ...
                        <tbody className='font-inter text-[12px] lg:text-[14px] text-white '>
                            {tabledata.map((item, index) => (
                                <tr key={index} className={`text-start ${index % 2 === 1 ? 'even:bg-gray-200' : 'bg-[#151536]'}`}>
