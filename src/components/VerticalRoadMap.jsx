    ...
    <>
      <div className="bg-white ">
        <div className="container xl:w-[1140px] 2xl:w-[1320px] mx-auto px-3 sm:px-5 xl:px-0 pb-24">
          ...
          <p className="max-w-[912px] text-center mx-auto text-dark-gray text-sm font-normal font-Inter leading-normal">
              ...
              <div className="md:hidden block">
                <div className="flex items-center absolute top-[0%] left-[-25px] ">
                  <div className="w-50px h-50px bg-white rounded-[50%] border-2 border-black flex justify-center items-center">
                    <h3 className="text-[#3c278d] font-Inter font-semibold md:text-2xl text-xl leading-normal">
                      1
                    </h3>
                  </div>
              ...
              <div className="md:w-2/4 w-full">
                <div className=" lg:ps-10 md:ps-6 ps-20">
                  <div className="flex flex-col justify-start">
                    <h4 className="text-black font-Inter max-w-[400px] font-normal md:text-lg text-md leading-normal mb-2">
