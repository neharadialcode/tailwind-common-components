      ...
      <div className="max-w-[652px] mx-auto px-6 py-[92px]">
        ...
        >
          <div className="flex justify-center sm:flex-row flex-col sm:gap-6 gap-3 pt-61px">
            <div className="sm:w-1/2 w-full relative">
              <input
                ...
                className="outline-[#00000070] border border-[#8F8F8F] w-full px-5 py-3 font-inter text-[#8F8F8F] sm:text-sm text-xs font-normal leading-[157%] rounded-xl"
                onChange={(e) =>
              ...
              <p className="requiredHeight mb-2">
                {error && typicalForm.name === "" ? (
                  <p className="absolute bottom-[-30%] left-0 text-red-600 font-Inter font-medium leading-[157%] sm:text-sm text-xs">
                    Name is required
                  </p>
                ) : (
                  typicalForm !== ""
            ...
            <div className="sm:w-1/2 w-full relative">
              ...
              <p className="">
                {error &&
                typicalForm.email ===
                  "text-black font-Inter font-medium leading-[157%] sm:text-sm text-xs" ? (
                  "Email is required"
          ...
          <div className="w-full pt-4 relative">
            <textarea
              placeholder="Message"
              className="outline-[#00000070] border border-[#8F8F8F] w-full px-5 py-3 font-inter text-[#8F8F8F] sm:text-sm text-xs font-normal leading-[157%] rounded-xl h-[107px]"
              onChange={(e) =>
          ...
          <div className="w-full pt-4 relative">
            <div className="flex justify-between items-center border border-[#8F8F8F] rounded-xl">
              <input
                ...
                className="outline-[#00000070] w-full px-5 py-3 font-inter rounded-xl text-[#8F8F8F] sm:text-sm text-xs font-normal leading-[157%]"
                onChange={(e) =>
                  setTypicalForm({ ...typicalForm, number: e.target.value })
                }
                value={typicalForm.number}
              />
              <button className="bg-blue h-[51px] w-[135px] flex justify-center items-center rounded-xl font-Inter sm:text-sm text-xs font-semibold leading-[157%] text-white hover:bg-white border-transparent hover:border-blue border-2 transition-all duration-300 hover:text-blue">
                Submit
              </button>
            </div>
