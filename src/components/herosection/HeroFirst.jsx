...
const HeroFirst = () => {
  return (
    <>
      <div className="lg:min-h-screen flex flex-col justify-center max-w-[1920px] mx-auto">
        <NavbarSpaceCenter />
        <div className=" bg-[url('./assets/images/png/hero_first_bg.png')] bg-center bg-no-repeat bg-[length:101%_101%] lg:flex-grow flex md:py-48 py-24 lg:py-0 h-full items-center">
