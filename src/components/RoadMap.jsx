    ...
    <>
      <div className="bg-white ">
        <div className="container xl:w-[1140px] 2xl:w-[1320px] mx-auto px-3 sm:px-5 xl:px-0 pb-24">
          <h3 className="font-Inter text-center font-semibold md:text-lg text-3md text-black mb-4 leading-normal">
            Road Map
          </h3>
          <p className="max-w-[912px] mx-auto text-center text-dark-gray text-sm font-normal font-Inter leading-normal">
              ...
              <div className="md:hidden block">
                <div className="flex items-center absolute top-[0%] left-[-25px] ">
                  <div className="w-50px h-50px bg-white rounded-[50%] border-2 border-black flex justify-center items-center">
                    <h3 className="text-[#3c278d] font-Inter font-semibold md:text-3md text-2md leading-normal">
                      1
                    </h3>
                  </div>
            ...
            <div className="flex mt-61px">
              <div className=" md:w-2/4 md:block hidden relative">
                <div className="flex items-center absolute md:top-50px top-0 md:right-0 ">
                  <div className="w-70px h-70px bg-white rounded-[50%] border-2 border-black flex justify-center items-center">
                    <h3 className="text-[#3c278d] font-Inter font-semibold md:text-3md text-2md leading-normal">
                      1
                    </h3>
                  </div>
              ...
              <div className="md:w-2/4 w-full">
                <div className=" lg:ps-10 md:ps-6 ps-20">
                  <div className="flex flex-col justify-start">
                    <h4 className="text-black font-Inter max-w-[400px] font-normal md:text-2md text-md leading-normal mb-2">
                      Inception and prepration
                    </h4>
                    <p className="font-normal max-w-[400px] text-dark-gray font-Inter text-sm leading-[150%]">
              ...
              <div className="md:w-2/4 w-full">
                <div className="flex md:justify-end justify-start">
                  <div className=" lg:pe-10 md:pe-6 md:ps-0 ps-20">
                    <div className=" flex md:justify-end justify-start mt-8">
                      <h4 className="text-black font-Inter max-w-[400px] font-normal md:text-2md text-md leading-normal mb-2">
                        Inception and prepration
                      </h4>
                    </div>
