  ...
  return (
    <div className="bg-white min-h-screen flex justify-center items-center">
      <div className="container xl:w-[1140px] 2xl:w-[1320px] mx-auto px-3 sm:px-5 xl:px-0">
        <h3 className="text-black text-center sm:text-3xl text-2xl font-semibold font-Inter">
          Our Team
        </h3>
        <p className="max-w-[912px] text-center mx-auto mt-4 text-dark-gray text-sm font-normal font-Inter leading-normal">
          ...
          {card.map((data) => {
            return (
              <div className=" px-3 lg:w-1/4 sm:w-2/4">
                <div className=" max-w-[345px] px-3 bg-card-bg lg:mb-0 mb-6 py-6 sm:py-8 rounded-xl hover:scale-105 duration-300 transition-all">
